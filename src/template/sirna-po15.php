...
function po_scripts_and_styles() {
    ...
    if (!is_admin()) {
        ...
        // bxslider
        wp_register_script( 'po-bxslider', get_template_directory_uri() . '/script/vendor/bx-slider.js/dist/jquery.bxslider.js', array( 'po-jquery' ), '', true );
        ...
        wp_enqueue_script( 'po-po-bxslider' );
